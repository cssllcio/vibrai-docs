...
description: "Install the Vibrai Agent Skill — a portable SKILL.md that teaches Claude Code, Codex CLI, or Gemini CLI to drive Vibrai."
keywords: ["agent skill", "SKILL.md", "claude code", "codex cli", "gemini cli", "vibrai skill install", "vibrai://skill"]
---
