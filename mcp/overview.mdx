...
Each MCP tool corresponds directly to a method on the underlying engine or bridge. Tools are grouped by domain: transport, tracks, clips, notes, drum maps, follow actions, automation, devices, instruments, scenes, arrangement, scales, project, genre, generation, capture, sessions, license, install, update, and version.
