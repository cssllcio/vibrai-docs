...
| .NET 10 runtime | [dotnet.microsoft.com/download](https://dotnet.microsoft.com/download) — only needed for source builds; the package installer is self-contained |
