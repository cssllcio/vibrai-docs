...
<Tabs>
  <Tab title="macOS">
    ...
    <Note>
      Upgrading from a build older than 1.6.4? It checks an old location and always says "up to date". Reinstall once from [vibrai.com/download](https://vibrai.com/download); `vibrai update` works normally after that.
    </Note>
  </Tab>
  <Tab title="Windows">
