...
<ParamField path="path_contains" type="String" required>
...
<ParamField path="path_prefix" type="String" required>
...
<ParamField path="tagged" type="Nullable`1" required>
  If true, only items with at least one user tag; if false, only untagged; null = both.
</ParamField>
<ParamField path="offset" type="Int32" required>
...
<ParamField path="pattern_set" type="String" required>
